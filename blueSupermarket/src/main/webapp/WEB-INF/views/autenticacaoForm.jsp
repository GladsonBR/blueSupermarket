        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-3 mx-auto mt-5">
                    <form id="demo-form"  class="bg-light border border-secondary rounded p-5" action="http://localhost:8080/blueSupermarket/login" method="post">
                        ...
                        <input class="form-control" type="password" id="senha" name="senha" />
                            <br/>
                        <div class="g-recaptcha" data-sitekey="6LfXSVMjAAAAAAp5V6v0qISzZCwwfjRyqqTqzMPE"></div>
